...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame]))
	{
        ...
        {
            [self   performSelector:@selector(didDoubleTap:) withObject:nil afterDelay:0.1];
        }
        else
        {
            [self   performSelector:@selector(animateZoomScale) withObject:nil  afterDelay:0.1];
        }
...
-(void)animateZoomScale
{
    [self   setZoomScale:0.5 animated:YES];
}
...
//    self.maximumZoomScale = 2.0; // 16.0 or whatever you need
//    
