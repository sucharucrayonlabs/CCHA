...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame]))
    {
		...
		tiledLayer.frame = CGRectMake(0, 0, mainFrame.size.width, mainFrame.size.height- 44);
		[tiledLayer setTileSize:CGSizeMake(mainFrame.size.width, mainFrame.size.height)];
